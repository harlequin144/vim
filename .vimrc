...
" toggle between dark and light with f5
call togglebg#map("<F5>")

set number

" start scrolling three lines before the border, keeps more context
set scrolloff=3
...
" when vim runs within an xterm, by default it inherits the terminal’s current
" title.
